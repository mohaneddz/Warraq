    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
        ...
        <div className="xl:col-span-1 flex flex-col gap-6">
          <div className="bg-white dark:bg-[#1d2926] p-6 rounded-2xl shadow-card border border-black/5 dark:border-white/5 flex flex-col h-[300px]">
            <div className="mb-4">
        ...
        <div className="xl:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Activity Overview */}
          <Panel title={<div className="flex items-center gap-2"><div className="w-4 h-4 rounded bg-[#b96f3e] flex items-center justify-center text-white text-[10px]">U</div> {t("dashboard.activityOverview")}</div>} className="md:col-span-1">
          ...
          <Panel title={t("dashboard.activeDepartments")} subtitle={t("dashboard.deptsHelp")} actionText={t("dashboard.viewAll")} className="md:col-span-1">
