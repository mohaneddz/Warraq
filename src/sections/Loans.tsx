...
import {
  Search, Clock, RotateCcw, RefreshCw, BookOpen, Calendar,
...
export function LoansPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      {/* Header. No "new loan" action here on purpose: a loan starts by fulfilling a
          reservation, so creating one from this screen would be a second, divergent way to
          do the same thing. */}
      <div className="mb-8">
